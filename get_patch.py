...
#    torch.set_default_dtype(torch.float32) 
    root = 'data/test'
    train_data  = datagenerator(data_dir = root,patch_size = (40,40),stride = (32,32),train_data_num =1000,download=False,datasets =0,aug_times=0,scales = [1,0.9,0.8],verbose=False,jump=80,agc=False)
...
#    DDataset = DenoisingDataset(xs,50)
    DDataset = DownsamplingDataset(xs,0.5,regular = False)
